...
const Appointment = () => {
     return (
          <div style={{background:`url(${appointment})`}} className="hero mt-32 border">
               <div  className=" flex gap-5 lg:flex-row items-center lg:mx-20 mx-3 my-2 lg:my-0">

                    <img src={img} alt='' className="w-1/2 h-full -mt-20 rounded-lg hidden lg:block " />

                    <div className='text-white'>
                         <p className='text-xl font-bold text-primary my-3'>Appointment</p>
                         <h1 className="text-4xl font-semibold my-3">Make an appointment Today</h1>
